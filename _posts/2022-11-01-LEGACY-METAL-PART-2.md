...
The first challenge we face is obtaining 3802 Compilers for our Metal 1 GPUs. As we discussed in [Part 1](/_posts/2022-11-01-LEGACY-METAL-PART-1.md), we don't have access to any semi-modern compilers. Thus we need to find a way to extract them from Apple's `dyld_shared_cache`.
