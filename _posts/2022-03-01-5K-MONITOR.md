...
Once I had resolved these issues, I was onto booting the iMac. With the display was connected, I received a 4k signal and all worked fairly well. For the majority of this system's life, I planned to run it through VNC as Thunderbolt 2 NAS (approximately 16Gbps~ when running the x4 PCIe 2.0 lanes).
...
Having gone through this experiment, I have to say I'm extremely pleased with the results
